# Data-analytics
### Привет! 👋
Меня зовут Алексей и я начинающий аналитик данных.
 🤯
...
К проекту также были мной написаны два парсера, дополняющие пропущенные данные. В сам проект они не включены и выложены отдельно, так как нужно их доработать.
  ...
  <tr>
    ...
    <td>На основе данных сервиса Яндекс Недвижимость о продаже квартир в Санкт-Петербурге и соседних населённых пунктах мне было поручено проведение анализа рынка квартир, выставляемых на продажу в городе Санкт-Петербург и выявление факторов влияющих на ее цену и срок продажи.
